...
description: Use when working in a Defold repository and the task is specifically about preserving that project's Defold folder layout, naming patterns, collection/message conventions, scene flow, or shared helper usage before editing.
---
